...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Total Gaji Bruto  Rp. " + gajiBruto.toString());
        System.out.println("Total Kebutuhan Wajib  Rp. " + gajiBruto.toString());
        System.out.println("Total Gaji Neto (PKP)  Rp. " + gajiNeto.toString());
